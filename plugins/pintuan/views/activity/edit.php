...
<!--                <el-form-item prop="add_robot_time" v-if="form.is_auto_add_robot === 1">-->
<!--                    <template slot="label">-->
<!--                        <span>机器人参与时间</span>-->
<!--                        <el-tooltip effect="dark" content="设置X分钟，则表示开团后，每X分钟将有一个机器人参与拼团" placement="top">-->
<!--                            <i class="el-icon-info"></i>-->
<!--                        </el-tooltip>-->
<!---->
<!--                    </template>-->
<!--                   <div flex="" class="robot_time">-->
<!--                       <div>每&nbsp;&nbsp;&nbsp;&nbsp;</div>-->
<!--                      <div>-->
<!--                          <el-input type="number" placeholder="请输入时间" min="0"-->
<!--                                    oninput="this.value = this.value.replace(/[^0-9]/g, '');"-->
<!--                                    v-model.number="form.add_robot_time">-->
