        ...
        <div class="form-body">
            <el-form :model="ruleForm" :rules="rules" size="small" ref="ruleForm" label-width="130px">
                ...
                <el-form-item label="有效天数" v-if="ruleForm.expire_type == 1" prop="expire_day">
                    <el-input size="small" oninput="this.value = this.value.replace(/[^0-9]/, '');" type="number"
                ...
                <el-form-item label="核销总次数" prop="number">
                    <el-input placeholder="请输入整数" type="number" oninput="this.value = this.value.replace(/[^0-9]/, '');"
                ...
                <el-form-item label="可发放数量" prop="total_count">
                    ...
                    <el-input placeholder="请输入卡券可发放数量" oninput="this.value = this.value.replace(/[^0-9]/, '');"
                              type="number" :min="-1"
