            ...
            <el-form :model="cForm" :rules="cRule" ref="ruleForm" label-width="180px" size="small"
                ...
                <el-tabs v-model="activeName" @tab-click="handleClick">
                    <el-tab-pane label="商品设置" name="first" v-if="is_basic == 1">
                        ...
                        <!-- 价格库存 -->
                        <el-card shadow="never" class="mt-24" v-if="is_price_inventory === 1">
                            <div slot="header">
                                <span>价格库存</span>
                            </div>
                            <el-row>
                                <el-col :xl="12" :lg="16">
                                    ...
                                    <slot name="before_price"></slot>

                                    <!-- 售价 -->
                                    <el-form-item label="售价" prop="price" v-if="no_price === 1">
                                        <el-input type="number"
                                                  :disabled="is_info == 0 && sign != 'pintuan' && sign !== 'flash_sale'"
                                    ...
                                    <slot name="before_original_price"></slot>

                                    <!-- 原价 -->
                                    <el-form-item prop="original_price"  :required="sign ? false : true" >
                                        <template slot="label">
                                            <span>原价</span>
                                            <el-tooltip effect="dark" content="以划线形式显示" placement="top">
                                                <i class="el-icon-info"></i>
                                    ...
                                    <slot name="after_original_price"></slot>

                                    <el-form-item v-if="cForm.extra && sign !== 'miaosha' && sign !== 'integral_mall' && sign !== 'booking' && sign !== 'step'" v-for="(item, key, index) in cForm.extra"
                                                  :key="item.id">
...
<!--                                    <el-form-item v-if="is_info == 1 && !is_mch" prop="is_negotiable">-->
<!--                                        <template slot='label'>-->
<!--                                            <span>价格面议</span>-->
...
<!--                                        </el-form-item>-->
                                    ...
                                    <!-- 规格 -->
                                    <el-form-item label="选择规格" v-if="is_attr == 0" required>
                                        <el-row type="flex">
                        ...
                        <el-card shadow="never" class="mt-24" v-if="is_purchase_settings === 1">
                            ...
                            <el-row>
                                <el-col :xl="12" :lg="16">
                                    ...
                                    <!-- 运费设置 -->
                                    <el-form-item prop="freight_id"  v-if="ruleForm.type == 'goods'">
                                        <template slot='label'>
                                            <span>运费设置</span>
                                    ...
                                    <!-- 单品满件包邮 -->
                                    <el-form-item label="" prop="pieces" v-if="ruleForm.type == 'goods'">
                                        <template slot='label'>
                                            <span>单品满件包邮</span>
                                    ...
                                    <!-- 单品满额包邮 -->
                                    <el-form-item prop="forehead" v-if="ruleForm.type == 'goods'">
                                        <template slot='label'>
                                            <span>单品满额包邮</span>
                                    ...
                                    <!-- 区域购买 -->
                                    <el-form-item label="区域购买" prop="is_area_limit" v-if="ruleForm.type == 'goods'">
                                        <el-switch
                        ...
                        <el-card shadow="never" class="mt-24" v-if="is_marketing === 1 && mch_id == 0">
                            ...
                            <el-row>
                                <el-col :xl="12" :lg="16">
                                    ...
                                    <el-form-item label="卡券发放" v-if="sign != 'mch'">
                            ...
                            <template v-if="sign === 'pintuan'">
                                <template v-if="pintuan_list.group_list.length > 0">
                                    <div class="pintuan-share">
                                        <el-card v-for="(item, index) in pintuan_list.group_list" :key="index">
                                            <app-goods-share v-model="pintuan_list.group_list[index]" :attr-groups="attrGroups"
                                                             :attr_setting_type="ruleForm.attr_setting_type"
                                                             :share_type="ruleForm.share_type"
                                                             :use_attr="ruleForm.use_attr"
                                                             :sign="sign"
    ...
    Vue.component('app-goods', {
        ...
        watch: {
            ...
            pintuan_list: function(newVal) {
                this.cForm.group_list = newVal.group_list;
            }
        },
        computed: {
            cForm() {
