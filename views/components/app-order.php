                        ...
                        <div class="goods-item" :style="{width: orderTitle[0].width}">
                            <div class="goods" v-for="(goods, iIndex) in item.detail">
                                <img :src="goods.goods_info && goods.goods_info.goods_attr && goods.goods_info.goods_attr.pic_url ? goods.goods_info.goods_attr.pic_url : goods.goods_info.goods_attr.cover_pic"
                                     class="goods-image">
                                <image style="width: 24px;height: 24px;position: absolute;left: 20px;" v-if="goods.goods.goodsWarehouse.type === 'goods' && isGoodsType && hide_function.is_show_ecard" src="statics/img/mall/goods.png"></image>
                                <image style="width: 24px;height: 24px;position: absolute;left: 20px;" v-if="goods.goods.goodsWarehouse.type === 'ecard' && isGoodsType && hide_function.is_show_ecard" src="statics/img/mall/ecard-goods.png"></image>
                ...
                <div :style="{width: mmConversionPx(printPar.stencil_width) + 'px',minHeight:mmConversionPx(printPar.stencil_high) + 'px', cursor: 'pointer', border: `${mmConversionPx(printPar.border_width)}px solid #000000`, boxSizing: 'content-box', margin: 0}">
                    ...
                    <div>
                        <div style="box-sizing:border-box;width: 100%;display: flex;border-bottom:1px solid #000000;position: relative;left: -0.5px;"
                            ...
                            <div style="box-sizing:border-box;width: 13%;border-left: 1px solid #000000;height: 30px;line-height: 30px;padding-left: 0.5%;font-size:10px;"
                                 v-if="printPar.goodsInf.article_number">货号
                            </div>

                            <div style="box-sizing:border-box;width: 13%;height: 30px;border-left: 1px solid #000000;line-height: 30px;padding-left: 0.5%;font-size:10px;"
                        ...
                        <div v-for="good in item.detail"
                             ...
                             v-if="printPar.goodsInf.serial || printPar.goodsInf.name || printPar.goodsInf.attr || printPar.goodsInf.number || printPar.goodsInf.univalent || printPar.goodsInf.article_number || printPar.goodsInf.unit">
                            <div style="word-wrap:break-word;box-sizing:border-box;width: 6%;word-wrap: break-word;border-left: 1px solid #000000;padding: 10px 10px 10px 0.5%;font-size:10px;position: relative"
                                 v-if="printPar.goodsInf.serial">
                                {{good.id}}
                            </div>
                            <div style="word-wrap:break-word;box-sizing:border-box;width: 26%;word-wrap: break-word;border-left: 1px solid #000000;padding: 10px 10px 10px 0.5%;font-size:10px;position: relative"
                                 v-if="printPar.goodsInf.name">
                                {{good.name}}
                            </div>

                            <div style="word-wrap:break-word;box-sizing:border-box;width: 18%;word-wrap: break-word;border-left: 1px solid #000000;font-size:10px;padding: 10px 10px 10px 0.5%;position: relative"
                                 v-if="printPar.goodsInf.attr">
                                {{good.attr}}
                            </div>
                            <div style="word-wrap:break-word;box-sizing:border-box;width: 12%;border-left: 1px solid #000000;font-size:10px;padding: 10px 10px 10px 0.5%;position: relative"
                            ...
                            <div style="word-wrap:break-word;box-sizing:border-box;width: 13%;border-left: 1px solid #000000;font-size:10px;padding: 10px 10px 10px .5%;position: relative"
                                 v-if="printPar.goodsInf.article_number">
                                {{good.goods_no}}
                            </div>
                            <div style="word-wrap:break-word;box-sizing:border-box;width: 13%;border-left: 1px solid #000000;word-wrap: break-word;font-size:10px;padding: 10px 10px 10px .5%;position: relative"
