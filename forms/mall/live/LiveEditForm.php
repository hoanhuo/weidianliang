...
class LiveEditForm extends Model
{
    ...
    private function checkData()
    {
        ...
        if (strtotime($this->end_time) - strtotime($this->start_time) < (30 * 60) || strtotime($this->end_time) - strtotime($this->start_time) > (12 * 60 * 60)) {
            throw new \Exception("开播时间和结束时间间隔不得短于30分钟，不得超过12小时");
        }
    }
}
