...
<!--        <img id="svgcode" style="height: 34px;"/>-->
<!--    </div>-->
                            ...
                            <div id="invoice"
                                ...
                                <div @click="showTab(3)"
                                    ...
                                    <div style="display: flex;border-bottom:1px solid #000000;position: relative;left: -0.5px;"
                                        ...
                                        <div style="width: 26%;border-left: 1px solid #000000;height: 30px;line-height: 30px;padding-left: .5%;font-size:10px;"
                                             v-if="goodsInf.name"
                                        >商品名称
                                        </div>
                                        <div style="width: 18%;border-left: 1px solid #000000;height: 30px;line-height: 30px;padding-left: 0.5%;font-size:10px;"
                                        ...
                                        <div style="width: 13%;border-left: 1px solid #000000;height: 30px;line-height: 30px;padding-left: 10px;font-size:10px;"
                                             v-if="goodsInf.article_number">货号
                                        </div>
                                        <div style="width: 13%;height: 30px;line-height: 30px;border-left: 1px solid #000000;padding-left: 10px;font-size:10px;"
                                    ...
                                    <div style="display: flex;border-bottom: 1px solid #000000;position: relative;left: -0.5px;"
                                        ...
                                        <div style="width: 26%;word-wrap: break-word;border-left: 1px solid #000000;font-size:10px;padding: 10px 10px 10px 0.5%;position: relative"
                                             v-if="goodsInf.name">
                                            <span>男士羊毛衫</span>
                                        </div>
                                        <div style="width: 18%;word-wrap: break-word;border-left: 1px solid #000000;font-size:10px;padding: 10px 10px 10px 0.5%;position: relative"
                                             v-if="goodsInf.attr">
                                            <span
                                        ...
                                        <div style="width: 13%;border-left: 1px solid #000000;font-size:10px;padding: 10px 10px 10px 0.5%;position: relative"
                                        ...
                                        <div style="width: 13%;word-wrap: break-word;border-left: 1px solid #000000;font-size:10px;padding: 10px 10px 10px 0.5%;position: relative"
                                             v-if="goodsInf.unit">
                   ...
                   <div style="display: inline-block;position: relative;white-space: nowrap;width: 100%;height: 50px">
                    ...
                    <div style="width: 100%;box-sizing:border-box;">
                        <div style="display: flex;border-bottom:1px solid #000000;width: 100%;position: relative;left: -0.5px;"
                            ...
                            <div style="width: 26%;border-left: 1px solid #000000;box-sizing:border-box;height: 30px;line-height: 30px;padding-left: 10px;font-size:10px;"
                            ...
                            <div style="width: 13%;border-left: 1px solid #000000;box-sizing:border-box;height: 30px;line-height: 30px;padding-left: .5%;font-size:10px;"
                                 v-if="printPar.goodsInf.article_number">货号
                            </div>
                            <div style="width: 13%;height: 30px;line-height: 30px;box-sizing:border-box;border-left: 1px solid #000000;padding-left: 10px;font-size:10px;"
                        ...
                        <div v-for="good in item.detail"
                             ...
                             v-if="printPar.goodsInf.serial || printPar.goodsInf.name || printPar.goodsInf.attr || printPar.goodsInf.number || printPar.goodsInf.univalent || printPar.goodsInf.article_number || printPar.goodsInf.unit">
                            <div style="word-wrap:break-word;width: 6%;box-sizing:border-box;word-wrap: break-word;border-left: 1px solid #000000;padding: 10px 10px 10px .5%;font-size:10px;position: relative"
                                 v-if="printPar.goodsInf.serial">
                                {{good.id}}
                            </div>
                            <div style="word-wrap:break-word;width: 26%;box-sizing:border-box;word-wrap: break-word;border-left: 1px solid #000000;padding: 10px 10px 10px .5%;font-size:10px;position: relative"
                                 v-if="printPar.goodsInf.name">
                                {{good.name}}
                            </div>
                            <div style="word-wrap:break-word;width: 18%;box-sizing:border-box;word-wrap: break-word;border-left: 1px solid #000000;font-size:10px ;padding: 10px 10px 10px .5%;position: relative"
                            ...
                            <div style="word-wrap:break-word;width: 13%;box-sizing:border-box;border-left: 1px solid #000000;font-size:10px;padding: 10px 0 10px .5%;position: relative"
                                 v-if="printPar.goodsInf.article_number">
                                {{good.goods_no}}
                            </div>
                            <div style="word-wrap:break-word;width: 13%;border-left: 1px solid #000000;box-sizing:border-box;word-wrap: break-word;font-size:10px;padding: 10px 0 10px .5%;position: relative"
