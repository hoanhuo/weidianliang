            ...
            <div class="table-body" v-loading="loading">
                ...
                <el-row :gutter="12">
                    <el-col :span="8">
                        <div class="card-box" style="padding: 0;">
                            ...
                            <div class="item-box item-margin" flex="dir:left cross:center" v-if="order.goods_type == 'goods'">
                            ...
                            <template>
                                ...
                                <div v-else-if="order.is_send == 1 && order.detailExpress.length == 1" class="item-box item-margin"
                                    ...
                                    <div flex="dir:left" v-if="order.detailExpress[0].send_type == 1">
                            ...
                            <div v-if="order.send_type == 2 && order.is_send == 1" class="item-box item-margin" flex="dir:top">
                                <div flex="dir:left cross:center">
                ...
                <el-card shadow="never" style="margin-top: 15px;">
                    <el-table stripe border :span-method="objectSpanMethod" :data="!isNewRequest ? goods_list : order.detail" style="width: 100%;margin-bottom: 15px;">
                        ...
                        <el-table-column align="center" label="折扣后" width="120">
                            <template slot-scope="scope">
                ...
                <div id="invoice" :style="{width: mmConversionPx(printPar.stencil_width) + 'px',minHeight:mmConversionPx(printPar.stencil_high) + 'px', marginLeft: printPar.offset.left + 'px', marginRight: printPar.offset.right + 'px', cursor: 'pointer', border: `${mmConversionPx(printPar.border_width)}px solid #000000`, boxSizing: 'content-box', margin: 0}">
                    ...
                    <div>
                        <div  style="box-sizing:border-box;width:100%;display: flex;border-bottom:1px solid #000000;position: relative;left: -0.5px;" v-if="printPar.goodsInf.serial || printPar.goodsInf.name || printPar.goodsInf.attr || printPar.goodsInf.number || printPar.goodsInf.univalent || printPar.goodsInf.article_number || printPar.goodsInf.unit">
                            ...
                            <div style="box-sizing:border-box;width: 26%;border-left: 1px solid #000000;height: 30px;line-height: 30px;padding-left: 0.5%;font-size:10px;"
                                 v-if="printPar.goodsInf.name"
                            >商品名称</div>
                            <div style="box-sizing:border-box;width: 18%;border-left: 1px solid #000000;height: 30px;line-height: 30px;padding-left: 0.5%;font-size:10px;" v-if="printPar.goodsInf.attr">规格</div>
                            <div style="box-sizing:border-box;width: 12%;border-left: 1px solid #000000;height: 30px;line-height: 30px;padding-left: 0.5%;font-size:10px;" v-if="printPar.goodsInf.number">数量</div>
                            ...
                            <div style="box-sizing:border-box;width: 13%;border-left: 1px solid #000000;height: 30px;line-height: 30px;padding-left: 0.5%;font-size:10px;"  v-if="printPar.goodsInf.article_number">货号</div>

                            <div style="box-sizing:border-box;width: 13%;border-left: 1px solid #000000;height: 30px;line-height: 30px;padding-left: 0.5%;font-size:10px;" v-if="printPar.goodsInf.unit">单位</div>
                        </div>
                        <div v-for="good in item.detail" style="box-sizing:border-box;width: 100%;display: flex;border-bottom: 1px solid #000000;position: relative;left: -0.5px;" v-if="printPar.goodsInf.serial || printPar.goodsInf.name || printPar.goodsInf.attr || printPar.goodsInf.number || printPar.goodsInf.univalent || printPar.goodsInf.article_number || printPar.goodsInf.unit">
                            ...
                            <div style="word-wrap:break-word;box-sizing:border-box;width: 26%;word-wrap: break-word;border-left: 1px solid #000000;padding:  10px 10px 10px 0.5%;font-size:10px;position: relative"  v-if="printPar.goodsInf.name">
                                {{good.name}}
                            </div>
                            <div style="word-wrap:break-word;box-sizing:border-box;width: 18%;word-wrap: break-word;border-left: 1px solid #000000;font-size:10px;padding: 10px 10px 10px 0.5%;position: relative" v-if="printPar.goodsInf.attr">
                                {{good.attr}}
                            </div>
                            <div style="word-wrap:break-word;box-sizing:border-box;width: 12%;border-left: 1px solid #000000;;font-size:10px;padding: 10px 10px 10px 0.5%;position: relative" v-if="printPar.goodsInf.number">
                                {{good.num}}
                            </div>
                            ...
                            <div style="word-wrap:break-word;box-sizing:border-box;width: 13%;border-left: 1px solid #000000;font-size:10px;padding: 10px 10px 10px 0.5%;position: relative" v-if="printPar.goodsInf.article_number">
                                {{good.goods_no}}
                            </div>
                            <div style="word-wrap:break-word;box-sizing:border-box;width: 13%;border-left: 1px solid #000000;word-wrap: break-word;font-size:10px;padding: 10px 10px 10px 0.5%;position: relative" v-if="printPar.goodsInf.unit">
                                {{good.unit}}
                            </div>
                        </div>
