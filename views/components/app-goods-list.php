...
<!--                                <el-button @click="download" v-if="exportParams.percentage == 100" size="small"-->
            ...
            <div class="table-body">
                <app-search :tabs="tabs" :new-search="search" :is-goods-type="isGoodsType" :is_mch="is_mch" :is_show_ecard="hide_function.is_show_ecard" @to-search="toSearch"
                ...
                <el-table
                    ...
                    <el-table-column prop="price" label="售价" sortable="false">
                        <template slot-scope="scope">
