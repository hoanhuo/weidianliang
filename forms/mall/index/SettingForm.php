    ...
    public function rules()
    {
        return [
            ...
            [['contact_tel', 'kdniao_mch_id', 'kdniao_api_key', 'member_integral_rule',
                ...
                'quick_customize_pic', 'quick_customize_open_type', 'quick_customize_link_url', 'mall_logo_pic'], 'string'],
            [['over_time', 'delivery_time', 'after_sale_time', 'member_integral',
                ...
                'is_goods_video', 'is_show_stock', 'is_use_stock', 'is_required_position', 'is_share_tip', 'is_quick_customize'], 'integer'],
            [['name'], 'required',],
            ...
            [['good_negotiable', 'payment_type', 'send_type', 'business_time_type_day', 'business_time_type_week',
                'auto_business_time', 'quick_customize_params', 'quick_customize_new_params'], 'safe'],
        ];
    }
    ...
    public function save()
    {
        ...
        try {
            ...
            foreach ($this->attributes as $k => $item) {
                ...
                if (in_array($k, ['good_negotiable', 'payment_type', 'send_type', 'business_time_type_week', 'business_time_type_day', 'quick_customize_new_params'])) {
