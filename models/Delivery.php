...
class Delivery extends ModelActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['customer_account', 'customer_pwd', 'month_code', 'outlets_name', 'outlets_code', 'company', 'name', 'tel', 'mobile', 'zip_code', 'province', 'city', 'district', 'address', 'template_size', 'goods_alias'], 'string', 'max' => 255],
        ];
    }
