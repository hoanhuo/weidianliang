                ...
                <el-tabs v-model="activeName">
                    <el-tab-pane label="基础设置" class="form-body" name="first">
                       <el-card style="margin-bottom: 10px">
                        ...
                        <app-setting v-model="setting" :is_coupon="true" :is_send_type="false"></app-setting>
                    </el-tab-pane>
            ...
            onSubmit() {
                ...
                self.$refs.form.validate((valid) => {
                    if (valid) {
                        ...
                        let { is_mail, is_sms, is_share, is_print, is_cat, is_form, payment_type, is_coupon, is_member_price, is_integral,svip_status, is_territorial_limitation } = this.setting;
                        let para = {
